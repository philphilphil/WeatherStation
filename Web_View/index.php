...
<table cellpadding="50" border="0">
	<tr>
		...
		<td><h1>Outdoor: <?php echo("tbd");#echo($json[count($json)-1]["temp"]);  ?>C&deg;</h1><h6>measured at <?php echo($json[count($json)-1]["date"]); ?></h6></td>
	</tr>
</table>
...
<h6>Arduino-powered Weather station with 3D-printed enclosure - Code on <a href='https://github.com/philphilphil/WeatherStation'>GitHub</a> - Blogpost about the hardware</h6>
</center>
</body>
</html>
